...
public class HalkTVWeb implements Serializable {
    ...
    public static WebFlow build() {
        ...
        LookupPattern articleLookup = new LookupPattern(LookupOptions.ARTICLE, LookupOptions.CONTAINER, "<div class=\"article-detail(.*?)\">", "</div>")
                .setStartEndMarker("<div", "</div>")
                .setNth(0)
                ...
                .addPattern(new LookupPattern(LookupOptions.TEXT, LookupOptions.ARTICLETITLE, "<h1(.*?)>", "</h1>")
                        .setNth(0)
                        .setRemoveTags(true))
                .addPattern(new LookupPattern(LookupOptions.ARTICLE, LookupOptions.ARTICLETEXT, "<article class=\"article-content\"(.*?)>", "</article>")
                        .setNth(0)
