...
public class HurriyetWeb implements Serializable {
    ...
    public static WebFlow build() {
        ...
        articleTemplate = new WebTemplate(LookupOptions.HURRIYETDIRECTORY, "article-text", domain)
                ...
                .setDomain(domain)
                .setDoRandomSeed(randomCount)
                .setHtmlSaveFolder(LookupOptions.HTMLHURRIYETDIRECTORY)
